...
const GreenhouseCropsWorksPlanningTomatoPage = () => {
  ////tsx
  return (
    <>
      <GreenhouseCropsWorksPlanningEntryPage variant="greenhouse_crops_works_works_planning_tomato" />
    </>
  );
};

export default GreenhouseCropsWorksPlanningTomatoPage;
