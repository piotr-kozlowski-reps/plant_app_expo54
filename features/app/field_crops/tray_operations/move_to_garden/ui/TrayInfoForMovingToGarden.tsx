...
type Props = {
  index: number;
  tray: TrayScannedValueForMovingToGarden;
  deleteAction: (tray: TrayScannedValueForMovingToGarden) => void;
};

const TrayInfoForMovingToGarden = (props: Props) => {
  ////vars
...
export default TrayInfoForMovingToGarden;
