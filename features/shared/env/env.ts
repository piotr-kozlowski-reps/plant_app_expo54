...
export let configPerBuild: Config = {
  ...
  edocReport_ExtraWorks_Nitrogen_Only: 1701,
  ...
  edocReport_ChemicalTreatmentsDon: 1744,
  edocReport_ZpNameData: 1703,
  edocReport_zpToCotyledonQuilting: 1709,
  edocReport_TrayForDonInfo: 1711,
  edocReport_ChemicalTreatmentsDonList: 1745,
  edocReport_ExtraWorksChemicalTreatmentsDon: 1746,
